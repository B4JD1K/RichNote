...
import {AuthModalForm} from "./ui/forms/auth-modal-form"
...
export const HeroHeader = () => {
  ...
  const toggleLoginForm = () => setIsLoggedIn(prev => !prev);
                ...
                {!session ? (
                  <>
                    <Dialog>
                      ...
                      <AuthModalForm isLoginForm={isLoggedIn} toggleForm={toggleLoginForm}/>
